  ...
  // Function to toggle back-to-top button visibility
    function toggleBackTop() {
        if ($(window).scrollTop() + $(window).height() >= $(document).height()) {
            $("#techrun-back-top").addClass("show");
        } else {
            $("#techrun-back-top").removeClass("show");
        }
    }
    ...
    // On click
    $documentOn.on('click', '#techrun-back-top', function() {
   ...
   navigation: {
    ...
    //>> Gt Testimonial box Slider Start <<//
      if($('.techrun-testimonial-box-slider').length > 0) {
        const gtTestimonialBoxSlider = new Swiper(".techrun-testimonial-box-slider", {
            slidesPerView: 'auto',
            spaceBetween: 20,
            freemode: true,
            centeredSlides: true,
    ...
    if($('.techrun-testimonial-box-slider-2').length > 0) {
        const gtTestimonialBoxSlider2 = new Swiper(".techrun-testimonial-box-slider-2", {
            slidesPerView: 'auto',
            spaceBetween: 20,
            freemode: true,
            centeredSlides: true,
    ...
    //>> techrun-Testimonial Slider Start <<//
        if($('.techrun-testimonial-slider-2').length > 0) {
        const gtTestimonialSlider2 = new Swiper(".techrun-testimonial-slider-2", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            autoplay: {
    ...
    //>> techrun-Instagram Slider Start <<//
     if($('.techrun-instagram-slider').length > 0) {
        const gtInstagramSlider = new Swiper(".techrun-instagram-slider", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            centeredSlides: true,
    ...
    //>> techrun-Brand Slider Start <<//
    if($('.techrun-brand-slider').length > 0) {
        const gtBrandSlider = new Swiper(".techrun-brand-slider", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            centeredSlides: true,
    ...
    //>> techrun-Artist Slider Start <<//
    if($('.techrun-artist-slider').length > 0) {
        const gtArtistSlider = new Swiper(".techrun-artist-slider", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            centeredSlides: true,
    ...
    //>> techrun-Artist Slider Start <<//
    if($('.techrun-speaker-slider').length > 0) {
        const gtSpeakerSlider = new Swiper(".techrun-speaker-slider", {
            spaceBetween: 30,
            speed: 1300,
            loop: true,
            centeredSlides: true,
    ...
    //>> techrun-event-schedule-item-4 Hover Image Show Slider Start <<//
        const scheduleItems = document.querySelectorAll(".techrun-event-schedule-item-4");
    ...
    //>> CountDown Start <<//
    document.querySelectorAll(".techrun-coming-soon-time").forEach(container => {
      ...
      const dayEl = container.querySelector(".techrun-day");
      const hourEl = container.querySelector(".techrun-hour");
      const minEl = container.querySelector(".techrun-min");
      const secEl = container.querySelector(".techrun-sec");
